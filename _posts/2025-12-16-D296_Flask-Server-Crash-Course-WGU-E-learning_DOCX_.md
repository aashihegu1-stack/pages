---
layout: post
title: "D296 Task 2: Flask Server Crash Course"
date: 2025-12-16 11:12:56 +0000
categories: ['WGU']
tags: ['wgu', 'd296']
author: John Mortensen
description: "WGU D296 assessment on building a Flask server for e-learning applications"
permalink: /wgu/d296/task2-flask-crash-course/
---
...
* Peer collaboration and live troubleshooting occur during demonstration
...
![Image ](/images/docx/D296_Flask-Server-Crash-Course-WGU-E-learning_image.png)
...
**Deliverable:** A demonstrated understanding and correct usage of authentication and authorization, supporting secure and individualized quest and admin features.
...
* Apply your best UI/UX ideas to improve the clarity and engagement of the user/learner.
...
**Deliverable:** An interactive, engaging, and data-driven quest experience that demonstrates thoughtful design and backend integration.
...
**Deliverable:** A fully operational backend with a simple yet functional admin UI for managing application data.
...
* *Example:* The teacher and the Teacher Aide circulate and give real-time help until table teams have the ability to progress independently.
...
* *Example:* All students build the same basic Flask app, but build or adapt APIs to meet their prototype project from Trimester 1 (i.e. Digital Famine or West Coast Quest frontend).

* Additionally, students are expected to build a project according to requirements to meet the College Board performance task.
...
* In-person, the instructor provides help as needed, but materials may not be accessible to all learners.
