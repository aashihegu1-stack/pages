---
layout: post
title: "D292 Task 2: Storyboard for an E-Learning Solution"
date: 2025-12-16 11:12:56 +0000
categories: ['WGU']
tags: ['wgu', 'd292']
author: John Mortensen
description: "Plagiarism lesson. Students will create a storyboard for their e-learning solution, outlining the key components and flow of the instructional materials."
...
<!-- Conversion date: 2026-03-25 23:22:19 -->
<!-- Images extracted: 9 -->
...
1. **Activation**: Learners are presented with a flawed research paper containing plagiarism.

2. **Demonstration**: The instructor and advanced cohorts model how to identify and correct citation errors.

3. **Application**: Learner's practice correcting the remaining errors using a rubric, with peer mentors providing immediate feedback.

4. **Integration**: Learners reflect on the activity and apply their skills in the next scaffolded assignment (a Mock Research Paper).

5. This strategy supports both high-tech and low-tech learners identified in the analysis (Part A). High-tech learners contribute as peer mentors, while low-tech learners benefit from guided, structured practice.

6. By aligning Merrill’s principles with UDL, the solution not only scaffolds instruction but also ensures inclusivity and accessibility. My reflection shows that what began as a focus on **problem-centered instruction** in ideation now clearly intersects with **UDL principles** as I move into prototyping.
...
1. **Instructor or administrator uploads the flawed research paper, rubric, and instructional video into the LMS.**

2. **Persona roles are integrated into the storyboard to ensure scaffolding for both high-tech (mentor roles) and low-tech learners (guided practice).**


**Demonstration of Content**


1. **The advanced cohorts (mentor roles) present citation correction through live demonstrations and share references to recorded examples and rubric.**

2. **The storyboard will emphasize design features (clear visuals, chunked steps, replayable videos) that support diverse learner needs.**


**Application and Assessment**


1. **Learner's practice correcting citations and building an APA reference list within the mock paper.**

2. **The rubric is embedded as both a guide and an assessment tool, with peer mentors providing immediate feedback.**

3. **Assessment data (rubric scores, completion, feedback) is captured to document progress toward the objective.**

4. **This storyboard plan ensures that instruction flows logically from preparation to demonstration to application, reinforcing Merrill’s First Principles of Instruction while incorporating UDL principles for inclusivity and accessibility.**


**C. Part II: Storyboard Prototype**

The LxD storyboard approach below uses GitHub Pages, Markdown, and HTML. It is published on the internet [here](https://jm1021.github.io/student/english/plagiarism), but all relevant elements for this assignment are captured within the document in slide-like visuals.
...
![Image 9](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_image9.png)
...
![Image a](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_imagea.png)
...
![Image b](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_imageb.png)
...
![Image c](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_imagec.png)

Workshop Tool

![Image d](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_imaged.png)

Tool Sample

![Image e](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_imagee.png)
...
![Image f](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_imagef.png)
...
![Image 10](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_image10.png)
...
![Image 11](/images/docx/D292_Plagiarism-WGU-SGM2-Task2-Storyboard-Higher-Level-Education_image11.png)
