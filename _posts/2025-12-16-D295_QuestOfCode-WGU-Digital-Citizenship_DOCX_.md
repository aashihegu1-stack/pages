---
layout: post
title: "D295 Task 1: Digital Citizenship Ideation"
date: 2025-12-16 11:12:56 +0000
categories: ['WGU']
tags: ['wgu', 'd295']
author: John Mortensen
description: "WGU D295 assessment focusing on digital citizenship education ideation phase"
permalink: /wgu/d295/task1-ideation/
---

<!-- Converted from: QuestOfCode-WGU-Digital-Citizenship.docx -->
...
**AP Computer Science Principles - Create Performance Task:** [Student Task Directions](https://apcentral.collegeboard.org/media/pdf/ap-csp-student-task-directions.pdf)
...
This project will have several built-in checkpoints and reviews. T*he Quest of Code represents a transformative approach to computer science education, combining technical skill development with creative problem-solving and ethical technology practices. All these events are recorded on Canvas, LMS.*
...
3. All coding projects are published to the Open Coding Society **[OCS, 2025]** GitHub repository which contains an Apache [license](https://github.com/Open-Coding-Society/pages/blob/main/LICENSE).
...
**[OCS, 2025]** Open Coding Society. (2025). *Open Coding Society Curriculum Portal.* Retrieved from [https://pages.opencodingsociety.com](https://pages.opencodingsociety.com/)